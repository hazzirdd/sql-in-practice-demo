...
//This is the same syntax as CONNECTION_STRING from our .env file
...
module.exports = {
    getUserInfo: (req, res) => {
        ...
        .then((dbRes) => {
            res.status(200).send(dbRes[0]); //Postgres will always put your data at hte [0] index of dbRes
        })
        .catch((err) => {
            console.log(err);
        })
    ...
    updateUserInfo: (req, res) => {
        ...
        requestAppointment: (req, res) => {
            ...
            VALUES(${clientId}, '${date}', '${service}', 'WootWoot', false, false)
            RETURNING *;`)
            .then((dbRes) => {
                res.status(200).send(dbRes[0])
            })
